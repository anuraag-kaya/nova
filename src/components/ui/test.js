   ...
   <div className="flex-1 overflow-y-auto p-6">
     ...
     <div className="space-y-4">
                   ...
                   {sourceFiles?.[index] ? (
                     <div className="flex items-center justify-between">
                       <div className="flex items-center gap-2">
                         ...
                         <span className="text-sm font-medium text-gray-900">{sourceFiles[index].name}</span>
                       </div>
                     ...
                     <div className="flex items-center gap-2 text-gray-500">
                       ...
                       <span className="text-sm">{index === 0 ? 'Source file (required)' : `Source file ${index + 1} (optional)`}</span>
                     </div>
                   )}
                 </div>
               </label>
             ...
             {targetFile ? (
               <div className="flex items-center justify-between">
                 <div className="flex items-center gap-2">
                   ...
                   <span className="text-sm font-medium text-gray-900">{targetFile.name}</span>
                 </div>
               ...
               <div className="flex items-center gap-2 text-gray-500">
                 ...
                 <span className="text-sm">Click to upload target file</span>
               </div>
             )}
           </div>
         </label>
             ...
             {mappingFile ? (
               <div className="flex items-center justify-between">
                 <div className="flex items-center gap-2">
                   ...
                   <span className="text-sm font-medium text-gray-900">{mappingFile.name}</span>
                 </div>
               ...
               <div className="flex items-center gap-2 text-gray-500">
                 ...
                 <span className="text-sm">Click to upload mapping rules</span>
               </div>
             )}
           </div>
         </label>
       ...
       <button
         ...
         className={`w-full py-3 rounded-lg font-medium flex items-center justify-center gap-2 transition-all text-sm ${
